...
with(bar, {
  plot( DateTime, as.numeric(bar$Global_active_power), type="l", xlab = "", ylab = "Global Active Power") 
  ...
  plot( DateTime, as.numeric(bar$Global_reactive_power), type="l", xlab = "datetime", ylab = "Global_reactive_power") 
